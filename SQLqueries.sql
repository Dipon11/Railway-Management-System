...
select * from journey join train on journey.j_train=train.t_id join coach on coach.c_id=journey.j_coach where from_st=7001 and to_st=7002 and j_date='2022-03-12'

select s_id from station where s_name='Dhaka'

select s_id from station where s_name='Kishoreganj'
